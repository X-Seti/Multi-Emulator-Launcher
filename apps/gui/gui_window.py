...
try:
    ...
    print("Warning: Retro conversion methods not available")
...
class MainGUI(QWidget): #vers 3
    ...
    def _create_toolbar(self): #vers 12
        ...
        self.export_all_btn = QPushButton("Batch Convert")
        ...
        self.export_all_btn.clicked.connect(self._show_batch_convert)
        ...
        # Switch button
        self.switch_btn = QPushButton("Resize")
        ...
        self.switch_btn.clicked.connect(self._show_texture_resize)
        self.switch_btn.setEnabled(True)
        self.switch_btn.setToolTip("Resize texture to common retro system dimensions")
